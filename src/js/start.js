...
function resetLeft(leftIndex) {
    document.getElementById("left-pfp").src = `/holi/img/${leftIndex}.jpg`;
    document.getElementById("left-bg").style.backgroundImage = `url("/holi/img/${leftIndex}.jpg")`
...
export function resetRight(rightIndex) {
    document.getElementById("right-pfp").src = `/holi/img/${rightIndex}.jpg`;
    document.getElementById("right-bg").style.backgroundImage = `url("/holi/img/${rightIndex}.jpg")`
